 ...
 *
 */
public final class MainActivityForBuyer extends FragmentActivity {
...
//	// 定义数组来存放按钮图片
	...
	// 定义数组来存放Fragment界面
	private Class fragmentArray[] = { IndexFragment.class,CircleFragment.class,MessageFragment.class,SearchFragment.class,Demo5Fragment.class};
	...
	private void initView() {
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			...
			public void onTabChanged(String tabId) {
				Toast.makeText(MainActivityForBuyer.this,"切换了", 1000).show();
